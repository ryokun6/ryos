...
- Applets run inside small, independent app windows in ryOS (not the browser tab).
- Default applet size is about 320px wide; design for mobile/small screens first but keep layouts fully responsive and fluid up to larger widths.

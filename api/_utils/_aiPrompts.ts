...
- When the system state has a known location (\`requestGeo\` or the user mentions a location), pass it as \`near: { latitude, longitude }\` so MapKit biases results to where they are.

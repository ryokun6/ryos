...
/**
 * Type for a Web API style handler function
 */
export type WebApiHandler = (req: Request) => Promise<Response>;

/**
 * Type for a Node.js style handler function
 */
export type NodeHandler = (req: VercelRequest, res: VercelResponse) => Promise<void>;
...
/**
 * Send Web API Response through VercelResponse
 */
...
/**
 * Wrap a Web API style handler for Node.js runtime
 * 
 * This adapter allows existing handlers that use the Request/Response Web API
 * to work with Vercel's Node.js runtime (which uses VercelRequest/VercelResponse).
 * 
 * @example
 * ```ts
 * // Original Web API style handler
 ...
 * }
 * 
 * // Wrap for Node.js runtime
 * export default wrapHandler(webHandler);
 * ```
 */
export function wrapHandler(handler: WebApiHandler): NodeHandler {

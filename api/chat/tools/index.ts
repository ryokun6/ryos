...
export const TOOL_DESCRIPTIONS = {
  ...
  searchSongs:
    "Search for songs/videos on YouTube. Returns a list of results with video IDs, titles, and channel names. Use this to help users find music to add to iPod or Karaoke. PREFER official music videos from verified artist channels (look for 'VEVO' or the artist's official channel). AVOID karaoke versions, instrumental versions, playlists, compilations, 'best of' collections, lyric videos, and covers unless specifically requested. After getting results, use ipodControl with action 'addAndPlay' for iPod requests, or karaokeControl with action 'addAndPlay' for Karaoke requests.",

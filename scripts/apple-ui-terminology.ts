...
export const ENGLISH_STYLE_EXPECTATIONS = {
  ...
  "apps.maps.youbike.startNavigation": "Start Navigation",
  "apps.maps.youbike.stopNavigation": "Stop Navigation",
  "apps.maps.placeCard.drive": "Drive",
  "apps.maps.placeCard.transit": "Transit",
  "apps.maps.placeCard.openInAppleMaps": "Open in Apple Maps",
  "apps.maps.placeCard.openInGoogleMaps": "Open in Google Maps",
  "apps.maps.directions.driveTitle": "Driving Directions",
  "apps.maps.directions.transitTitle": "Transit Directions",

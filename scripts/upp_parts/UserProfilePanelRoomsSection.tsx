...
type Props = Pick<
  ...
  "t" | "profile" | "isLoading" | "isRoomsOpen" | "roomsCount" | "dispatchProfileUi"
>;

export function UserProfilePanelRoomsSection(props: Props) {
  const { t, profile, isLoading, isRoomsOpen, roomsCount, dispatchProfileUi } = props;
  return (
      {/* Rooms */}
      {isLoading ? (

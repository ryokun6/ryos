...
export const API_TEST_FILES = [
  ...
  "tests/integration/api/test-stuff-remove-background.test.ts",
  ...
  "tests/integration/api/test-youbike-route.test.ts",

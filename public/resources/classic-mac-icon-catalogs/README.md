...
System 7 and Mac OS 8 were extracted from HFS images with resource forks preserved via `hfsutils` MacBinary export, then converted with `rsrcdump`. Mac OS 9 uses the already-extracted resource-derived PNG set from `bearz314/MacOS9-icons`.

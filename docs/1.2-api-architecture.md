...
|----------|--------|-----------|
| **OpenAI** | gpt-6 (gpt-6-astra, default), gpt-5.5 | Default chat, code generation |
| **Anthropic** | sonnet-4.6 (claude-sonnet-4-6), opus-5.5 (claude-opus-5-5, ryo + debug) | Complex reasoning |

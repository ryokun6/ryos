...
### Supported Models (AI SDK 7)

The API uses Vercel AI SDK 7 with structured outputs for type-safe responses.

| Provider | Models | Use Cases |
|----------|--------|-----------|
| **OpenAI** | gpt-6 (gpt-6-astra, default), gpt-5.5 (ryo + debug) | Default chat, applet text and image, title parsing |
| **Anthropic** | opus-5.5 (claude-opus-5-5, ryo + debug) | Complex reasoning |

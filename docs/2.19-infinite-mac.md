...
*   **12 System Presets**: Choose from a curated selection of historic Mac OS versions including System 1.0, System 6.0.8, System 7.5.3, KanjiTalk 7.5.3, Mac OS 8.0, Mac OS 8.5, Mac OS 9.0, Mac OS 9.2.2, and Mac OS X 10.1-10.4.
*   **Display Scaling**: Adjust the emulator display with 1x, 1.5x, or 2x scaling options to optimize for your screen size.
*   **Pause / Resume**: Pause the emulator when not actively using it to save system resources, and resume when ready.
*   **Screenshot Capture**: Capture screenshots of the emulated Mac desktop directly from the View menu.
*   **Automatic Window Sizing**: The window automatically resizes to match each system's native screen resolution.

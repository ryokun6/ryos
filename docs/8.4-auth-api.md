...
The chat rooms authentication system uses token-based authentication with 1-year expiration (refreshed on each validated request). Users authenticate using:

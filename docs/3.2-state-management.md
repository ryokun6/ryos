...
| `useKaraokeStore` | Karaoke session state | `ryos:karaoke` |
| `useThemeStore` | OS theme selection | Manual localStorage (`os_theme`) |
...
| `useAppletStore` | Applet metadata, window sizes | `ryos:applets` |
| `useSoundboardStore` | Soundboard slots | `ryos:soundboard` |

...
- iPod and Karaoke expose Automatic, Traditional, and Simplified choices in the Pronunciation menu; Automatic follows the current Chinese ryOS locale and otherwise preserves the Traditional default

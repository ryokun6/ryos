...
| `dropdown-menu` | Base UI Menu | Context/dropdown menus |
| `select` | Base UI Select | Selection dropdowns |
| `slider` | Base UI Slider | Value sliders |
| `switch` | Base UI Switch | Toggle switches |
| `tabs` | Base UI Tabs | Tabbed interfaces |
| `checkbox` | Base UI Checkbox | Checkboxes |
| `tooltip` | Base UI Tooltip | Hover tooltips |
| `scroll-area` | Base UI ScrollArea | Custom scrollbars |

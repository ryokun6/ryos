...
The Karaoke app transforms your ryOS environment into a personal karaoke studio. Users can easily search for and add songs from YouTube, building a comprehensive music library shared with the iPod app. Its core functionality revolves around providing a seamless lyric display experience, where text scrolls in sync with the music, complete with options for adjusting timing precision. This library is seamlessly shared with the [iPod](/docs/ipod) app.
...
*   **CoverFlow Album Browser**: Browse your music library with an iTunes-style CoverFlow interface featuring smooth 3D-perspective album art, pan gestures for navigation, and responsive sizing that adapts to your window. Activate via long-press on the album art or from the View menu.
*   **Comprehensive Song Library Management**: Easily search YouTube for a vast selection of songs, or paste direct URLs to add tracks to your personal library. This library is seamlessly shared with the ryOS [iPod](/docs/ipod) app.
...
*   **Seamless Integration with iPod**: Share a unified music library with the ryOS [iPod](/docs/ipod) app, allowing you to add songs in either application and access them across both.
*   **Voice Control and Chat Integration**: Control playback, adjust settings, and request songs directly through ryOS's [Chats](/docs/chats) functionality by interacting with Ryo.
...
*   **Open CoverFlow**: Long-press on the album art to open the CoverFlow browser, or select "Cover Flow" from the View menu.
*   **Navigate CoverFlow**: Swipe left/right, drag, or click side album covers to browse through your library. Click the center album or press Enter to select.
...
### Tips & Shortcuts
*   **Long-press album art**: Opens CoverFlow browser for visual library navigation.

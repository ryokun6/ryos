...
The server assigns message sequence numbers, maintains a monotonic revision, and
keeps at most 200 text messages within a 256 KiB text budget. Reasoning,
provider metadata, images, and tool payloads are not retained.
...
Conversation records are removed by account deletion.

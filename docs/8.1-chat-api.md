...
Focus and visibility refreshes remain as a fallback for events missed while a
device was offline. Anonymous conversations remain device-local and do not

...
server conversation contains messages. Reset requires the current conversation
ID and returns a new ID. Conversation records are removed by account deletion.

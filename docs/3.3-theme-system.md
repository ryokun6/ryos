...
ryOS supports 4 base OS themes emulating classic operating systems, plus macOS Aqua variants for material (`classic` / `glass`) and color scheme (`light` / `dark`). Themes use comprehensive CSS variable systems, centralized metadata helpers, and platform-specific UI behaviors.

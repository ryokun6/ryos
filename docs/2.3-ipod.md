...
The iPod app for ryOS brings the classic 1st generation iPod experience to your web desktop. It allows you to manage and play music from YouTube or Apple Music, complete with iconic features like the click wheel, cover flow, and synchronized lyrics, all within a familiar retro interface.
...
*   **Using Apple Music:** Switch the library source to Apple Music, sign in when prompted, and browse songs, playlists, Recently Added, or Favorite Songs. Sharing an Apple Music song copies its Apple Music link rather than creating a ryOS shared-song entry.

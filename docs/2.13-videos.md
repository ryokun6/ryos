...
The Videos app for ryOS provides a retro-style YouTube playlist player, featuring a classic QuickTime-inspired interface. It's designed to offer a straightforward multimedia experience directly within your desktop environment.

## Overview

The Videos app serves as ryOS's YouTube playlist player. Users can add videos by pasting any YouTube URL into the playlist. Playlists can feed the TV app's channel lineup. This makes it a versatile tool for entertainment, educational content, or background video while working in other ryOS apps.
...
*   **[iPod](/docs/ipod)**: For audio playback and music library management within ryOS.

...
Run `bun run i18n:apple-glossary` before auditing only when the Apple terminology source data changes. It refreshes the glossary input used by the audit script, not the app locale catalogs themselves.

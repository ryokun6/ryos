...
| `ui-core` | @base-ui/react (dialog, menu, select, etc.) | ~80KB |
...
| `v86` | v86 emulator runtime | Virtual PC |
...
bun run electron:build          # Build all configured desktop artifacts

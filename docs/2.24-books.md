...
*   **OPDS Catalog:** Point an e-reader's OPDS client at `https://<host>/api/opds` and use your ryOS username/password to browse and download synced `/Books` EPUBs. See `docs/8.12-opds-api.md`.

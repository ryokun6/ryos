...
*   **KOReader Sync:** Point KOReader’s Progress Sync custom server at `https://<host>/api/kosync`, register with your ryOS username, and keep EPUB filenames identical under `/Books` so progress stays shared. See `docs/8.11-kosync-api.md`.

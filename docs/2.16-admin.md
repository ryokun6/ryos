...
*   **[Control Panels](/docs/control-panels)**: While the Admin app provides system-wide configuration, the Control Panels app allows individual users to customize their personal ryOS experience and preferences.

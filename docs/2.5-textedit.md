...
-   `src/apps/textedit/hooks/useFileOperations.ts`: Provides abstracted functions for creating, opening, saving, and exporting files, integrating with ryOS's file system.
...
*   **[Finder](/docs/finder):** For managing and organizing your saved text documents within the ryOS file system.

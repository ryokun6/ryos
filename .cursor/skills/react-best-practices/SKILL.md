...
Comprehensive performance optimization guide for React applications, maintained by Vercel. Contains 70 rules across 8 categories, prioritized by impact. Sourced from [vercel-labs/agent-skills](https://github.com/vercel-labs/agent-skills/tree/main/skills/react-best-practices).
...
- Implementing client data fetching or API route handlers
- Reviewing code for performance issues
- Refactoring for bundle size, re-renders, or load time

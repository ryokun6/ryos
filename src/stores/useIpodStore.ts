...
import { loadDefaultTracks } from "@/stores/ipodLibraryData";
...
// Track caching/preload lives in @/stores/ipodLibraryData so that main.tsx can
// preload tracks without pulling this entire store into the entry chunk.

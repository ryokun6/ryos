...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, asChild = false, ...props }, ref) => {
    ...
    const resolvedClassName = (() => {
      ...
      if (isMacTheme && variant === "default") return cn("aqua-button primary", className);
      if (isMacTheme && variant === "secondary") return cn("aqua-button secondary", className);
      if (isMacTheme && variant === "retro") return cn("aqua-button secondary", className);
      ...
      if ((isXpTheme || isMacTheme) && variant === "ghost") {
    ...
    const resolvedStyle = (() => {
      if (isMacTheme && (variant === "default" || variant === "secondary" || variant === "retro")) {

...
import { groupSpotlightResults } from "./groupSpotlightResults";
import { getSpotlightPrefetchAppId } from "./spotlightSectionUtils";
...
export type SpotlightSearchViewModel = ReturnType<

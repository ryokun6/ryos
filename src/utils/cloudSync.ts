...
import {
  applyContactsSyncSnapshot,
  mergeContactsSyncSnapshots,
  serializeContactsSyncSnapshot,
...
async function applySettingsSnapshot(
  ...
  await applySettingsSyncSnapshot(data, fallbackUpdatedAt, {
    beforeApply: async (normalizedData) => {

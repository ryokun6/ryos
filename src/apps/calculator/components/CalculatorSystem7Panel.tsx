...
export function CalculatorSystem7Panel({
  ...
  return (
    <div className="calc-s7-panel flex flex-col gap-[4px]">
      ...
      <div className="calc-s7-grid">
        ...
        <CalculatorKey label="E" onClick={onClearEntry} theme={theme} variant="function" style={{ gridColumn: 2, gridRow: 1 }} />
        <CalculatorKey label="=" onClick={onEquals} theme={theme} variant="equals" style={{ gridColumn: 3, gridRow: 1 }} />

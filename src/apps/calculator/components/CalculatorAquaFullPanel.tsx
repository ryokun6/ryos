  ...
  return (
    <div className="calc-aqua-full flex flex-col gap-1">
      ...
      <div className="calc-aqua-full-grid">
        ...
        <CalculatorKey label="MC" onClick={onMemoryClear} theme={theme} variant="function" className={fn} groupClassName="calc-number-group-start" style={{ gridColumn: 5, gridRow: 1 }} />
        <CalculatorKey label="M+" onClick={onMemoryAdd} theme={theme} variant="function" className={fn} style={{ gridColumn: 6, gridRow: 1 }} />
        <CalculatorKey label="M−" onClick={onMemorySubtract} theme={theme} variant="function" className={fn} style={{ gridColumn: 7, gridRow: 1 }} />
        <CalculatorKey label="MR" onClick={onMemoryRecall} theme={theme} variant="function" className={fn} style={{ gridColumn: 8, gridRow: 1 }} />
        ...
        <CalculatorKey label="AC" onClick={onClear} theme={theme} variant="function" className={fn} groupClassName="calc-number-group-start" style={{ gridColumn: 5, gridRow: 2 }} />
        <CalculatorKey label="C" onClick={onClearEntry} theme={theme} variant="function" className={fn} style={{ gridColumn: 6, gridRow: 2 }} />
        ...
        <CalculatorKey label="7" onClick={() => onDigit("7")} theme={theme} groupClassName="calc-number-group-start" style={{ gridColumn: 5, gridRow: 3 }} />
        <CalculatorKey label="8" onClick={() => onDigit("8")} theme={theme} style={{ gridColumn: 6, gridRow: 3 }} />
        <CalculatorKey label="9" onClick={() => onDigit("9")} theme={theme} style={{ gridColumn: 7, gridRow: 3 }} />
        <CalculatorKey label="−" onClick={() => onOperator("-")} theme={theme} variant="operator" style={{ gridColumn: 8, gridRow: 3 }} />
        ...
        <CalculatorKey label="4" onClick={() => onDigit("4")} theme={theme} groupClassName="calc-number-group-start" style={{ gridColumn: 5, gridRow: 4 }} />
        <CalculatorKey label="5" onClick={() => onDigit("5")} theme={theme} style={{ gridColumn: 6, gridRow: 4 }} />
        <CalculatorKey label="6" onClick={() => onDigit("6")} theme={theme} style={{ gridColumn: 7, gridRow: 4 }} />
        <CalculatorKey label="+" onClick={() => onOperator("+")} theme={theme} variant="operator" style={{ gridColumn: 8, gridRow: 4 }} />
        ...
        <CalculatorKey label="1" onClick={() => onDigit("1")} theme={theme} groupClassName="calc-number-group-start" style={{ gridColumn: 5, gridRow: 5 }} />
        <CalculatorKey label="2" onClick={() => onDigit("2")} theme={theme} style={{ gridColumn: 6, gridRow: 5 }} />
        <CalculatorKey label="3" onClick={() => onDigit("3")} theme={theme} style={{ gridColumn: 7, gridRow: 5 }} />
        <CalculatorKey
          label="="
          onClick={onEquals}
          theme={theme}
          variant="equals"
          style={{ gridColumn: 8, gridRow: "5 / span 2" }}
        />
        ...
        <CalculatorKey label="0" onClick={() => onDigit("0")} theme={theme} variant="wide" groupClassName="calc-number-group-start" style={{ gridColumn: "5 / span 2", gridRow: 6 }} />
        <CalculatorKey label="." onClick={onDecimal} theme={theme} style={{ gridColumn: 7, gridRow: 6 }} />
      </div>
    </div>
  );
}

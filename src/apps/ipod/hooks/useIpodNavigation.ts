...
import type { MenuHistoryEntry, MenuItem, WheelArea, RotationDirection } from "../types";
...
import { EMPTY_IPOD_MENU_ITEMS } from "./ipodLogicConstants";
import type { useIpodPlayback } from "./useIpodPlayback";
import type { useIpodGames } from "./useIpodGames";

type PlaybackApi = ReturnType<typeof useIpodPlayback>;
type GamesApi = ReturnType<typeof useIpodGames>;

export interface UseIpodNavigationOptions {
...
export function useIpodNavigation({
  isWindowOpen,
  instanceId,
  playback,
  games,
}: UseIpodNavigationOptions) {
